...
namespace SnakeMess
{
	...
	class SnakeMess
	{
		public static void Main(string[] arguments)
		{
            ...
            //Plasering av poeng/punkter å plukke opp.
			...
			while (true) {
				...
				if (spot) {
					Console.ForegroundColor = ConsoleColor.Blue; Console.SetCursorPosition(app.X, app.Y); Console.Write("$");
					break;
				}
			}
			Stopwatch t = new Stopwatch();
			t.Start();
            //Player kontrollene, hvilke knapper man kan bruke og hva de gjør.
			while (!gg) {
